...
{    
	...
	/*
	container.SetGutter( 0 );
	container.SetSpace( 0, 0 );
	container.SetSize( 75, 50 );
	...
	container.AddToggle( "green", 0, 0, "group", "", decoAtom, decoAtomD );
	container.AddToggle( "green", 1, 0 );
	container.AddToggle( "green", 2, 0 );
	*/
