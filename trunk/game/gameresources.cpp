...
#	undef COLORDEF
	...
	static const WeaponInit weapons[] = {		
		...
		{ "ASLT-2",	"ASLT-2",	DECO_RIFLE,		"Gecko Assault Rifle",	{ "Snap", "Auto", "Boom" },		SPEED_NORMAL,
		...
		{ "LR-1",	"LR-1",		DECO_RIFLE,		"Long Range",			{ "Snap", "Aimed", 0 },		SPEED_NORMAL,
				...
				0 },
		{ "LR-2",	"LR-2",		DECO_RIFLE,		"Marksman Long Range",	{ "Snap", "Aimed", 0 },		SPEED_NORMAL,
				"Clip",			0,										DAM_HI,			ACC_VHI*A2,	"ar3l",
				0 },
		{ "LR-3",	"LR-3",		DECO_RIFLE,		"Callahan Long Range",	{ "Snap", "Aimed", 0 },		SPEED_NORMAL,
		...
		{ "MCAN-2",	"CANON-2",	DECO_PISTOL,	"Valiant Mini-Canon",	{ "Snap", "Flame", "Boom" },	SPEED_SLOW,
				"Flame",		WEAPON_EXPLOSIVE,						EXDAM_MED*B2,	ACC_MED,	"can",
				"RPG",			WEAPON_EXPLOSIVE,						EXDAM_MED*B2,	ACC_MED,	"can", },
		{ "MCAN-3",	"CANON-3",	DECO_PISTOL,	"Dauntless Mini-Canon",	{ "Snap", "Flame", "Boom" },	SPEED_SLOW,
